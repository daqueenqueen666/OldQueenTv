...
def main_list(params):    
    plugintools.add_item( #Television
        action="television", 
        title="[COLOR gold]Televisión[/COLOR]",
        thumbnail="https://i.imgur.com/Z3cLHUG.jpg",
        url= "",
		fanart="https://i.imgur.com/Z3cLHUG.jpg",
        folder=True )     
    plugintools.add_item( #Cine
        ...
        url= "",
		fanart="https://i.imgur.com/H8uNV7J.jpg",
        folder=True )               
    plugintools.add_item( #Serie
        ...
        url= "",
		fanart="https://i.imgur.com/W5OPv4w.jpg",
        folder=True )  
    plugintools.add_item( #Anime
        ...
        url= "",
		fanart="https://i.imgur.com/ZJdKIq6.jpg",
        folder=True )      
    ...
    plugintools.add_item( #Documentales
        ...
        url= "",
		fanart="https://i.imgur.com/bGVX0Tf.jpg",
        folder=True )   
